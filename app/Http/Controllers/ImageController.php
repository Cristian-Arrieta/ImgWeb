...
class ImageController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		return redirect()->route('images.show',compact('image'))->with('info','Imagen guardada correctamente');
    }
    ...
    public function edit(Image $image)
    {
		if ( Auth::user()->can('users.edit') || ( Auth::user()->id == $image->users->id))
		{
			...
			return redirect()->route('images.show',compact('image'))->with('alert','No tiene permiso para actualizar esta Imagen')	;		
    }
    ...
    public function update(Request $request,Image $image)
    {
		if ( Auth::user()->can('users.edit') || ( Auth::user()->id == $image->users->id))
		{
			...
			return redirect()->route('images.show',$image->id)->with('info','Imagen Actualizada Correctamente');
		}
		else
			return redirect()->route('images.show',compact('image'))->with('alert','No tiene permiso para actualizar esta Imagen')	;
    }
    ...
    {	
		...
		$image->delete();
        return redirect()->route('users.show',compact('user'))->with('info','Se elimino Correctamente');
    }
