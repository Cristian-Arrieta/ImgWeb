...
<head>
	...
	<link rel="manifet" href="{{ asset('img/icono/favicon-32x32.png') }}" >
		...
		<!-- Menu Lateral -->
			<div id="mySidenav" class="sidenav">
			  ...
			  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
				...
				<li>
					<a class="nav-link"  href="{{route('home')}}"><span class="oi oi-home"></span> Home </a>
				</li>
					...
					<ul class="navbar-nav ml-auto">										 
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a style="font-size:15px;color:white" id="navbarDropdown" class="nav-link dropdown-toggle badge badge-pill badge-dark" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
