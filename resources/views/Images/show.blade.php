    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
			...
			@if(auth()->user() && auth()->user()->id != $user->id)	
				<button class="btn btn-info action-follow" data-id="{{ $user->id }}"><strong>
										...
										@for($i = 0 ; $i < 4 ; $i++)
											...
											<div class="col-md-3 mb-3">
												<figure>
													...
													<img class="img-fluid rounded w-100 mb-2" src="{{($images[$i]->img_min())}} "  alt="Card image cap">
													<h4 class="text-center my-3">{{$images[$i]->name}}</h4>
													</a>
												</figure>
											</div>
