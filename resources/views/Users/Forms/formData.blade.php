...
<div class="form-group">
	{{ Form::label('password_org','Current Password')}}
	{{ Form::password('password_org',['class' => 'form-control'])}}
</div>
<p class="text-muted">*The "Current Password" field is required</p></center>

<div class="form-group">
	{{ Form::label('password','New Password')}}
	{{ Form::password('password',['class' => 'form-control'])}}
</div>
<p class="text-muted">*The "New Password" field is optional</p></center>
<br>
<!--
<div class="form-group">
